...
(function () {
    angular.module('waitrApp').controller('CustomerHomeController', ['restaurantService', '$timeout', CustomerHomeController]);
...
(function () {
  angular.module('waitrApp').controller('custRestaurantCtrl', ['restaurantService', 'userService', 'waitlistService', '$stateParams', '$ionicHistory', '$state', '$timeout', '$scope', custRestaurantCtrl]);
 ...
 */
(function () {
  angular.module('waitrApp').controller('custWaitListConfirmCtrl', ['$stateParams', '$timeout', '$scope', 'waitlistService', 'restaurantService', '$state', 'userService', '$ionicHistory', custWaitListConfirmCtrl]);
  ...
  function custWaitListConfirmCtrl($stateParams, $timeout, $scope, waitlistService, restaurantService, $state, userService, $ionicHistory) {
    ...
    cwlc.userAddingToQ = function (firstname, lastname, partysize, phone, notes) {
      ...
      waitlistService.addAnonToWaitlist(person, cwlc.currRestObj[0].waitlist_id).then(function (res) {
        console.log("res: ", res);
...
(function () {
  angular.module('waitrApp').controller('custSettingsCtrl', ['userService', '$state', '$timeout', '$scope', custSettingsCtrl]);
